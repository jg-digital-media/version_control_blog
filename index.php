...
<body>
    ...
    <!--
        ...
        Add project from list add.
        Create a branch - checkout between branches. Note the differences between the branchs
        merge into main branch.  Push

        Edit a log - Force fields have been established on all turbo lifts and crawlways. Computer, run a level-two diagnostic on warp-drive systems. 

        View the repository - clone it to reveal the log and list of branches
